    ...
    <>
      <div className="relative w-[130px] text-[14px] max-[500px]:w-[105px] max-[500px]:text-[10px]">
        <button
          ...
          className={`w-full flex justify-between items-center rounded-md  bg-[#323232] px-3 py-2 text-white shadow-sm hover:border-gray-400 transition-all duration-200 ${
            ...
            >
              {languages.map((lang) => (
                <li
                  ...
                  className={`px-3 py-2 flex items-center gap-2 cursor-pointer transition-all duration-150 text-[#4e4e4e] ${
